...
add wave -noupdate -format analog-step -radix decimal -min -10.0 -max +10.0 -height 64 -color "Azure"  tb/u
...
add wave -noupdate -format Logic -radix unsigned tb/qcw_inst/*
